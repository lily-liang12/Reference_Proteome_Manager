...
## User Guide
A [User Guide](Reference_Proteome_Manager_UniProt/User_Guide_UniProt.pptx) is included in this repo to help users. Please check that out for more detailed information on how to use the program.
